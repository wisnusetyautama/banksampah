...
<!-- start content -->
                ...
                <form action="<?php echo base_url("Blog/posting"); ?>" class="form-horizontal style-form" method="post" name="power" enctype="multipart/form-data" onsubmit="return validation();">
                          <div class="col-lg-12" align="right">
                            <button type="submit" class="btn btn-primary btn-lg" name="submit" value="submit">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-send"></span> Publish&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </button>
                            <a href="<?php echo base_url("Blog"); ?>" class="btn btn-danger btn-lg " data-dismiss="modal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-trash"></span> Cancel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                          </div> 
<br><br>
                    <center><div class="form-group">
                      <div class="col-lg-5">
                        <input type="text" class="form-control" name="judul_post" id="judul_post" placeholder="       Judul       " style="    border: none; border-bottom: 2px solid red; font-size: 40px; text-align: center; overflow: hidden; word-wrap: break-word; height: 62px; resize: horizontal;" required="true" />
                      </div>
                    </div></center>
                  ...
                  <label class="col-lg-3 control-label" for="varchar"><strong>Penulis</strong></label>
                    <div class="form-group">
                      <div class="col-lg-5">
                        <input type="text" required="true" class="form-control" name="penulis" id="penulis" placeholder="Penulis        " style=" border: none; border-bottom: 2px solid red; font-size: 18px;" />
                      </div>
                    </div>
                  ...
                  <label class="col-lg-3 control-label" for="file"><strong>Post</strong></label>
                    <div class="form-group">
                      <div class="col-lg-12">
                        <textarea class="ckeditor" id="ckedtor" name="post"></textarea>
                      </div>
                    </div>
                  ...
                  <label class="col-lg-3 control-label" for="file"><strong>Foto</strong></label>
                    <div class="form-group">
                      <div class="col-lg-5">
                        ...
                        <input id="uploadImage" required="true" type="file" name="image" onchange="previewImage(this,[150],4);" />
                        </div>
                    </div> 
                    ...
                    <div class="form-group col-lg-5">
                      ...
                      ?>
                        <div class="checkbox-group required">
                          <label>
                            <input type="checkbox" name="category[]" value="<?php echo $category->id; ?>"> <?php echo $category->kategori; ?>
                          </label>
                        </div>
                      <?php
                          }
...
<!-- end content -->
    ...
    <script src="<?php echo base_url(); ?>asset/admin/js/html5.image.preview.js"></script>
